...
int main(int argc, char **argv)
	...
	isError = argCountError(argc, "./pgmb2a inputImage.pgm outputImage.pgm"); 
    ...
    image.isBinary = 0; // set flag to ascii

	// write out image file
	isError = writeFile(argv[2], &image);
        // writeFunction automatically converts to base 16 if flagged as bin
	if(isError != 0) 	return isError;
